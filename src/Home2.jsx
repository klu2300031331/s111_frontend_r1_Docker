    ...
    <div className="app">
      ...
      <div id="home" className="hero-section">
        <div className="hero-text">
          ...
          <p className="subtext">
            Manage books, track borrowings, and access library resources efficiently.
          </p>
        </div>
      </div>
      ...
      <section id="about" className="info-section">
        ...
        <p>
          The Library Management System is a digital platform designed to simplify and automate
          library operations. It enables students and librarians to manage books, track borrowing
          activities, handle returns, and maintain records efficiently. The system provides secure
          access, real-time availability tracking, and an improved experience for both users and administrators.
        </p>
      </section>
      ...
      <section id="collections" className="info-section">
        ...
        <p>
          Explore a wide range of books and educational resources available in the library.
          The collection is organized into multiple categories for easy access and discovery:
        </p>

        <ul>
          <li>Academic & Reference Books</li>
          <li>Programming & Technology Resources</li>
          <li>Science & Research Materials</li>
          <li>Literature, Fiction & Non-Fiction</li>
        </ul>
      </section>
      ...
      <section id="events" className="events-section">
        <h2 className="section-title">
          Library Activities
          <img src="/event-books.jpg" alt="Library Activity" />
        </h2>

        <div className="events-content">
          <div className="events-text">
            <h4>NEW BOOK ARRIVALS</h4>
            <p>
              Stay updated with the latest additions to the library collection,
              including academic resources, novels, and technology books.
            </p>

            <h4>READING & LEARNING SESSIONS</h4>
            <p>
              Participate in guided reading sessions and collaborative learning activities
              designed to improve knowledge sharing among students.
            </p>

            <h4>WORKSHOPS & SEMINARS</h4>
            <p>
              Attend educational workshops, technical seminars, and book discussions
              conducted regularly by faculty members and guest speakers.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="support" className="info-section">
        ...
        <p>
          The Library Management System provides services such as book search,
          borrowing requests, issue and return tracking, renewal management,
          and user account maintenance to ensure a smooth library experience.
        </p>
      </section>

      {/* Contact Section */}
      <section id="contact" className="info-section">
        <h2>Contact Library Administration</h2>
        <p>Email: library@university.edu</p>
        <p>Phone: +91 98765 43210</p>
        <p>Location: Central Library, University Campus</p>
      </section>
    </div>
  )
}
